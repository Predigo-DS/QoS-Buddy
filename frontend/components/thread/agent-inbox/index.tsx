...
export function ThreadView({ interrupt }: ThreadViewProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col rounded-2xl bg-surface p-8 lg:flex-row">
      {showSidePanel ? (
        <StateView
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      idx === activeInterruptIndex
                        ...
                        : "hover:border-primary hover:text-primary border-border bg-background text-muted",
                    )}
                  >
                    {title}
                  </button>
