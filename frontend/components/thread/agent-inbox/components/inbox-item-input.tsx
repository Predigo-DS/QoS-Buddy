...
function ResetButton({ handleReset }: { handleReset: () => void }) {
  return (
    <Button
      onClick={handleReset}
      variant="ghost"
      className="flex items-center justify-center gap-2 text-muted hover:text-red-500"
    >
    ...
    <div className="flex w-full flex-col items-start gap-6">
      {Object.entries(args).map(([key, value]) => {
        ...
        return (
          ...
          >
            <p className="text-sm leading-[18px] text-wrap text-muted">
              {prettifyText(key)}
            </p>
            <span className="w-full max-w-full rounded-xl bg-background p-3 text-[13px] leading-[18px] text-text-main">
  ...
  return (
    <div className="flex w-full min-w-full flex-col items-start gap-4 rounded-lg border border-border p-6">
      <div className="flex w-full items-center justify-between">
        <p className="text-base font-semibold text-text-main">{header}</p>
...
function RejectActionCard({
  ...
  return (
    <div className="flex w-full max-w-full flex-col items-start gap-4 rounded-xl border border-border p-6">
      <div className="flex w-full items-center justify-between">
        <p className="text-base font-semibold text-text-main">Reject</p>
  ...
  return (
    <div className="flex w-full max-w-full flex-col items-start justify-start gap-2">
      ...
      <div className="flex w-full flex-col items-stretch gap-2">
        ...
        {isLoading && (
          <p className="text-sm text-muted">Submitting decision...</p>
        )}
