    ...
    <div className="flex w-full flex-col gap-1">
      {messages.map((msg, idx) => {
        ...
        return (
          ...
          >
            <p className="font-medium text-text-main">{messageTypeLabel}:</p>
...
function StateViewRecursive(props: StateViewRecursiveProps) {
  ...
  if (date) {
    return <p className="font-light text-muted">{date}</p>;
  }
  ...
  if (props.value == null) {
    return <p className="font-light whitespace-pre-wrap text-muted">null</p>;
  }
  ...
  if (Array.isArray(props.value)) {
    ...
    return (
      <div className="flex w-full flex-row items-start justify-start gap-1">
        <span className="font-normal text-text-main">[</span>
  ...
  if (typeof props.value === "object") {
    if (Object.keys(props.value).length === 0) {
      return <p className="font-light text-muted">{"{}"}</p>;
    }
    return (
  ...
  return (
    <span
      ...
      className={cn(
        ...
        "bg-background text-muted hover:bg-surface hover:text-text-main",
    ...
    <div className="relative flex flex-row items-start justify-start gap-2 text-sm">
      ...
      >
        <div
          ...
          className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md text-muted transition-colors ease-in-out hover:bg-surface hover:text-text-main"
        >
