    ...
    <div className="flex flex-row items-center justify-center gap-0">
      <Button
        ...
        className={cn(
          ...
          showingState ? "text-text-main" : "bg-background",
        )}
        size="sm"
      ...
      <Button
        ...
        className={cn(
          ...
          showingDescription ? "text-text-main" : "bg-background",
        )}
        size="sm"
...
export function ThreadActionsView({
  ...
  if (!isValidHitlRequest(interrupt)) {
    return (
      <div className="flex min-h-full w-full flex-col items-center justify-center rounded-2xl bg-surface p-8">
  ...
  return (
    <div className="flex min-h-full w-full max-w-full flex-col gap-9">
      ...
      <div className="flex w-full flex-row flex-wrap items-center justify-start gap-2">
        <Button
          variant="outline"
          className="border-border bg-background font-normal text-text-main"
