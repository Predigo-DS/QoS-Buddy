...
import { PanelRightOpen, PanelRightClose, LoaderCircle, Plus } from "lucide-react";
...
export default function ThreadHistory() {
  ...
  const { getThreads, createThread, threads, setThreads, threadsLoading, setThreadsLoading } =
    useThreads();
